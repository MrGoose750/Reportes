...
Partial Public Class DBRH_Ds
    ...
    Partial Public Class locationsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddlocationsRow(ByVal street_address As String, ByVal postal_code As String, ByVal city As String, ByVal state_province As String, ByVal country_id As String) As locationsRow
            Dim rowlocationsRow As locationsRow = CType(Me.NewRow,locationsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, street_address, postal_code, city, state_province, country_id}
